    ...
    if "%IS_RUNNABLE%" == "true" (
        ...
        if %JAVA_VERSION% GTR 8 (
            "%JAVA%" %JAVA_OPTS% %OPTS% ^
                ...
                --patch-module java.base=lib/endorsed/org.apache.karaf.specs.locator-4.2.3.jar ^
                --patch-module java.xml=lib/endorsed/org.apache.karaf.specs.java.xml-4.2.3.jar ^
